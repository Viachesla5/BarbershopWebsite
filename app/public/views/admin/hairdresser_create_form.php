...
<div class="container mx-auto mt-8">
    <h1 class="text-2xl font-bold mb-4">Create New Hairdresser</h1>

    <form action="/admin/hairdressers/create" method="POST" class="max-w-md bg-white p-6 rounded shadow">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="name" id="name" class="w-full border border-gray-300 px-3 py-2" required>
            <p class="text-red-500 text-sm mt-1">Required</p>
        </div>
        ...
        <div class="mb-4">
            ...
            <input type="text" name="specialization" id="specialization" class="w-full border border-gray-300 px-3 py-2" required>
            <p class="text-red-500 text-sm mt-1">Required</p>
        </div>
